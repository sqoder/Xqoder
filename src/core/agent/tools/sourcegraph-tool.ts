// ============================================================
// SourcegraphTool - Tool for searching code in public repositories
// ============================================================
...
LIMITATIONS: Max 20 results per query.`,
    ...
    async execute(args: Record<string, unknown>, _context: ToolContext): Promise<ToolResult> {
        ...
        try {
            ...
            const formatted = this.formatSourcegraphResults(data, contextWindow, count);
    ...
    /** Format Sourcegraph search results */
    private formatSourcegraphResults(result: Record<string, any>, contextWindow: number, count: number): string {
        let buffer = '';
