...
export function buildBehaviorLayer(): string {
    return [
        ...
        '- For repository explanations, prefer read-only inspection first: use search_code and read_file before considering run_shell, and only use run_shell when those read-only tools still cannot answer.',
