...
export type AppEvent = SessionStartedEvent | SessionResumedEvent | MessageStartedEvent | MessageDeltaEvent | MessageCompletedEvent | ToolCalledEvent | ToolOutputEvent | ToolCompletedEvent | ApprovalRequestedEvent | ApprovalResolvedEvent | StatusChangedEvent | ErrorEvent;
