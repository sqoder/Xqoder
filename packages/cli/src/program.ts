...
import { discoverCommandRegistrations, getBuiltInCommandRegistrations, type CommanderCommandRegistration } from './command-plugins.js';
import { applyRootShellOptions, resolveRootShellOutputFormat, runRootShellAction, type RootShellDependencies } from './root-shell.js';
